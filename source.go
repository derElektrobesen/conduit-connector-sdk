...
//go:generate mockgen -typed -destination=mock_source_test.go -self_package=github.com/derElektroBesen/conduit-connector-sdk -package=sdk -write_package_comment=false . Source
